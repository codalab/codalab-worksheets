class State(object):
    ...
    OPTIONS = {
        CREATED, STAGED, MAKING, WAITING_FOR_WORKER_STARTUP, STARTING, RUNNING,
        READY, FAILED, PREPARING, FINALIZING
    }
    ACTIVE_STATES = {
        MAKING, WAITING_FOR_WORKER_STARTUP, STARTING, RUNNING, FINALIZING,
        PREPARING
    }
