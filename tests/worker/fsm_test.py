...
class FiniteStateMachineTest(unittest.TestCase):
    ...
    def test_error_recovery(self):
        fsm = FiniteStateMachine(initial_state=Difficult())
        fsm.run()
        self.assertIsNone(fsm._state, "should have reached done state via error recovery")
