...
class JsonApiClientTest(unittest.TestCase):
    ...
    def test_resource_path(self):
        ...
        self.assertEqual(
            self.client._get_resource_path('bundles', 'abc'), '/bundles/abc'
        )
    ...
    def test_unpack_document(self):
        ...
        self.assertDictEqual(
            obj, {
                ...
                'parent':
                    JsonApiRelationship('bundles', '567'),
                'id':
                    '123',
                'name':
                    'hello'
    ...
    def test_fetch_one(self):
        ...
        self.assertEqual(
            client.fetch_one(None), {}, "fetch_one doesn't return dict directly"
        )
        self.assertEqual(
            client.fetch_one(1), {},
            "fetch_one doesn't extract single dict from list"
        )
