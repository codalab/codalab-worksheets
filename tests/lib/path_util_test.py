...
class PathUtilTest(unittest.TestCase):
    ...
    '''
        ...
        self.assertEqual(
            path_util.get_relative_path('asdf', 'asdfblah'), 'blah'
        )
        self.assertRaises(
    ...
    '''
        ...
        with mock.patch(
            'codalab.lib.path_util.recursive_ls', mock_recursive_ls
        ):
            with mock.patch(
                'codalab.lib.path_util.get_relative_path',
                mock_get_relative_path
            ):
                with mock.patch(
                    'codalab.lib.path_util.hash_file_contents',
    ...
    '''
        ...
        self.assertRaises(
            OSError, lambda: path_util.make_directory(self.test_path)
        )
        self.assertEqual(mock_os.mkdir.call_args_list, self.mkdir_calls)
