...
class DefaultBundleManager(BundleManager):
    ...
    def _fail_on_excess_resource(self, value, user_fail_string=None, global_fail_string=None, user_max=None, global_max=None):
        if value:
    ...
    def _fail_on_too_many_resources(self, workers):
        ...
        for bundle in self._model.batch_get_bundles(state=State.STAGED, bundle_type='run'):
            ...
            failures.append(self._fail_on_excess_resource(
