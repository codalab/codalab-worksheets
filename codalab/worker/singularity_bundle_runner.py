...
from codalab.worker.bundle_container import DEFAULT_RUNTIME, BundleContainer
...
class SingularityContainer(BundleContainer):
    ...
    def run(path,
        ...
        volumes = SingularityContainer.get_bundle_container_volume_binds(path, singularity_bundle_path, dependencies)
    ...
    @staticmethod
    def get_bundle_container_volume_binds(bundle_path, singularity_bundle_path, dependencies):
        """
