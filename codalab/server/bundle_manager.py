...
class BundleManager(object):
    ...
    def _filter_and_sort_workers(self, workers_list, bundle, bundle_resources):
        ...
        def get_sort_key(worker):
            ...
            # 1. prioritize workers that have more bundle dependencies.
            # 2. prioritize workers with fewer CPUs.
            # 3. prioritize workers with fewer running jobs.
            # 4. prioritize workers with lower random number.
            return (
                worker['gpus'],
                -num_available_deps,
                worker['cpus'],
