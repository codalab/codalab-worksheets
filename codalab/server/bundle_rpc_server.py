...
class BundleRPCServer(FileServer):
    ...
    def upload_bundle_zip(self, bundle_type, file_uuid, construct_args, worksheet_uuid):
        '''
        ...
        result = self.client.upload_bundle(bundle_type, path, construct_args, worksheet_uuid)
