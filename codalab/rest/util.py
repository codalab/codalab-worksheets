...
def get_group_info(group_spec, need_admin, access_all_groups=False):
    ...
    logger.info("Yibo: group_info.get('is_admin') is " + str(group_info.get('is_admin')))
    logger.info("Yibo: group_info.get('is_admin') is of " + str(type(group_info.get('is_admin'))))
