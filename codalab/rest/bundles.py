...
def _create_bundles():
    ...
    - `bundle_location`: UUID of the bundle location that the new bundle
    ...
    """
    worksheet_uuid = request.query.get('worksheet')
    bundle_location_uuid = request.query.get('bundle_location')
    ...
    for bundle in bundles:
        ...
        local.model.save_bundle(bundle, bundle_location_uuid=bundle_location_uuid)
