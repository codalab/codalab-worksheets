...
def fetch_interpreted_worksheet(uuid):
    ...
    # Expand user-written searches (including bundle & worksheet) with raw items.
    ...
    worksheet_info['items'] = list(chain.from_iterable(result))
    # raw_item_to_source_line: ith entry in the array means the ith raw item 
    #    was generated by worksheet_info["raw_item_to_source_line"][i] source line
    ...
    # This means raw item is the `sub_block_index` item of the `block_index` items block  
