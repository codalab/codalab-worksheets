...
# TODO (Ashwin): Once we can upgrade the minimum Python version of CodaLab to be 3.7,
# remove this file and replace instances of SeekableZipFile with just ZipFile.
# 
# To use it:
