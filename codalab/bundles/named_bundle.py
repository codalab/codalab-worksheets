...
class NamedBundle(Bundle):
    ...
    # fmt: off
    METADATA_SPECS = [
        MetadataSpec('name', str, 'Bundle names can only contain letters, digits, underscores, dots and dashes. Names can only start with a letter or an underscore.', short_key='n'),
