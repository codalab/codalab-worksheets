...
class RunBundle(DerivedBundle):
    ...
    METADATA_SPECS.append(MetadataSpec('request_docker_image', basestring, 'Which docker image (e.g., codalab/ubuntu:1.9) or digest we wish to use.', completer=DockerImagesCompleter))
