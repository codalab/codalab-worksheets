...
class RunBundle(DerivedBundle):
    ...
    METADATA_SPECS.append(MetadataSpec('preemptible', bool, 'Whether the bundle is currently running / finished on a preemptible worker.', generated=True, hide_when_anonymous=True,
                                       default=False))
    # fmt: on
