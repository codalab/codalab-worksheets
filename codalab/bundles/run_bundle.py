...
class RunBundle(DerivedBundle):
    ...
    METADATA_SPECS.append(MetadataSpec('remote_history', list, 'All workers where this job has been run (internal); multiple values indicate that the bundle was preempted and moved to a different worker.',
