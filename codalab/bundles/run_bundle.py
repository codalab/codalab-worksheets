...
class RunBundle(DerivedBundle):
    ...
    METADATA_SPECS.append(MetadataSpec(
        'run_status',
        str,
        'Execution status of the bundle (run_status).',
        generated=True
    ))
    METADATA_SPECS.append(MetadataSpec(
        'staged_status',
    ...
    METADATA_SPECS.append(MetadataSpec(
        ...
        float, 'Amount of system time in the UPLOADING_RESULTS stage (time_uploading_results).',
        generated=True,
        formatting='duration'
    ))
    METADATA_SPECS.append(MetadataSpec(
    ...
    METADATA_SPECS.append(MetadataSpec(
        'exitcode',
        int,
        'Exitcode of the process (exitcode).',
        generated=True
    ))
    METADATA_SPECS.append(MetadataSpec(
        'job_handle',
