...
class RunBundle(DerivedBundle):
    ...
    METADATA_SPECS.append(MetadataSpec('cpu_usage', float, 'Portion of CPU used by this container (e.g., 0.28)'))
    METADATA_SPECS.append(MetadataSpec('memory_usage', float, 'Portion of Memory used by this container (e.g., 0.16'))
